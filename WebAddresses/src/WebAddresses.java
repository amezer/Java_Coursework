//163	Records	Web Addresses  - code provided	30  Jocelyn Ho
...
public class WebAddresses
{
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println(tre.street + ", " + cuatro.city + ", " + cuatro.state + "  " + cuatro.zip);
        System.out.println(tre.street + ", " + cinco.city + ", " + cinco.state + "  " + cinco.zip);
    }
}
