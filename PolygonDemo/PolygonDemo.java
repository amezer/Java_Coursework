//85 Graphics Graphics Demo 4: Polygons 40 Jocelyn Ho

//If the order of the points added is been changed, the shape of the polygon will change because the order of the point been drawn is different [system will follow the order of the points added to draw the polygon]
...
public class PolygonDemo extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        tra.addPoint(700, 100);
        tra.addPoint(600, 100);
        tra.addPoint(500, 300);
        tra.addPoint(800, 300);
